...
wav_path = 'woman'
data_path = 'preprocess_RAW_hop128_win512_2048fft_multi_big'

# model ids are separate - that way you can use a new tts with an old wavernn and vice versa
# NB: expect undefined behaviour if models were trained on different DSP settings
voc_model_id = 'RAW_hop128_442_win512_5block_2048fft_multi2.0'
...
#########################  MultiBand-WaveRNN   #########################
voc_multiband = True
voc_upsample_factors = (4, 4, 2)   # 相乘应是hop_length/4
#########################  MultiBand-WaveRNN   #########################
